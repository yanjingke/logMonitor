...
public class monitorSendKafka {
    ...
    public static void main(String[] args) {
        ...
        getList();
        for (int mesageNo=1;mesageNo<100000000;mesageNo++){
            //    TOPIC,mesageNo+"" ,"appid"+UUID.randomUUID()+"itcast"
            Random rand = new Random();
            String msg = list.get(rand.nextInt(90)).toString();
            producer.send(new KeyedMessage<String, String>(TOPIC, mesageNo + "",msg));
