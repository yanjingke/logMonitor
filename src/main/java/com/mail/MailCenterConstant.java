...
public class MailCenterConstant {
    ...
    public final static String FROM_ADDRESS = "yanjingke960925@163.com";
    public final static String USER = "yanjingke960925@163.com";
    public final static String PWD = "yan96092";
}
